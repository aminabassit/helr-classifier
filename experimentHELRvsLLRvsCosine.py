...
matedSc, unMatedSc, matedScQ, unMatedScQ, matedScCosine, unMatedScCosine = matedUnmatedScores_LLR_HELR_Cosine(testIDs, testFeat, featsTestTrans, logDetTerm, diffFacs, sumFacs, binBorders, helrTabs)
...
print('-- Measure the performance of HELR')
_, fmrCosine, tmrCosine = get_fmr_tmr_Prec(matedScCosine, unMatedScCosine, precision = precisionD)
eerCosine = calc_eerPT(fmrCosine, tmrCosine)


plotFile = './results/DETs_Cosine_LLR_HELR_dQ_{}_nFQ_{}_{}.png'.format(dQ, nFQ, dataset)
plotTitle = 'LLR, HELR (dQ = {}; nFQ = {}) and Cosine {}'.format(dQ, nFQ, dataset) 
